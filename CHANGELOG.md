...
See the [v0.2.1 release](https://github.com/ML4PNP/MEGaNorm/releases/tag/v0.2.1) for detailed release notes.

## [0.2.0]

See the [v0.2.0 release](https://github.com/ML4PNP/MEGaNorm/releases/tag/v0.2.0) for detailed release notes.
